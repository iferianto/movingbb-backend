...
if (!class_exists('pdf_parser', false)) {
    ...
    class pdf_parser {
        ...
        function pdf_read_xref(&$result, $offset) {
                ...
                if ($line) {
                    ...
                    switch($c) {
                        ...
                        case 3:
                            ...
                            if (!array_key_exists($gen = (int) $potong[1], $result['xref'][$start])) {
                    	        $result['xref'][$start][$gen] = $potong[2] == 'n' ? (int) $potong[0] : null;
                    	    }
                            $start++;
                            break;
                        default:
            ...
            $lines = $potong = $line = $start = $end = $gen = null;
            unset($lines, $potong, $line, $start, $end, $gen);
